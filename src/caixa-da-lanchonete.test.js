...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['sem o item pricipal', 'dinheiro', 'Item não pode ser pedido como principal', ['combo1,1']],
        ['sem o item pricipal', 'debito', 'Item não pode ser pedido como principal', ['combo2,1']],
    ])('compra %p em %p deve resultar em %p.', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
